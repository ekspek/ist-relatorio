...
* Criar uma versão separada que adira aos regulamentos do Instituto Superior Técnico mais rigidamente (tipo de letra Arial, margens, etc.)
* Criar versões portuguesa e inglesa
* Criar capa
...
A lista completa de recursos, para além de informações sobre uso e exemplos, estão incluídos no relatório compilado em pdf.
